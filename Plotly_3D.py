...
#### !!!!!! Code MODIFIED Used only for storytelling purposes: 
#### Credit to Mykola: https://www.kaggle.com/c/champs-scalar-coupling/discussion/98598
...
def plot_molecule(molecule_name, structures_df):
    ...
    def atom_trace():
        ...
        markers = dict(color=colors, line=dict(color='tomato', width=1), size=10, symbol='square', opacity=0.8)
    ...
    layout = dict(scene=dict(xaxis=axis_params, yaxis=axis_params, zaxis=axis_params, annotations=annotations_length), 
                  margin=dict(r=0, l=0, b=0, t=0), showlegend=False, updatemenus=updatemenus)

    fig = go.Figure(data=data, layout=layout)
    fig.update_layout(title="Benzamidine: C7H8N2")
    
    fig.write_html("Pentene.html")

# Benzamidine: C7H8N2
molecule_name = 'dsgdb9nsd_133883'
# Cyanoacetic acid: C3H3NO
molecule_name = 'dsgdb9nsd_000500'
# 1-Pentene: C5H10
molecule_name = 'dsgdb9nsd_000100'

plot_molecule('Pentene', structures)
