...
Search<-twitteR::searchTwitter("#polymers",n=15)
(Search_DF <- twListToDF(Search))
TransactionTweetsFile = "Polymer_TweetResults.csv"
(Search_DF$text[1])
#################################################################################
...
write.table(TweetDF, file = "Polymer_UpdatedTweetFile.csv", col.names = FALSE, 
            row.names = FALSE, sep = ",")
TweetTrans <- read.transactions("Polymer_UpdatedTweetFile.csv", sep =",", 
